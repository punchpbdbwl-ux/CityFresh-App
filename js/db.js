...
const DB = (() => {
  ...
  function getDefaultCategories() {
    return [
      { id:1, name:'Apple',       icon:'🍎', bg:'#8BAC4A', fg:'#1A1A1A' },
      { id:2, name:'Blueberry',   icon:'🫐', bg:'#7B5EA7', fg:'#fff' },
      { id:3, name:'Raspberry',   icon:'🍓', bg:'#D4537E', fg:'#fff' },
      { id:4, name:'Strawberry',  icon:'🍓', bg:'#C84040', fg:'#fff' },
      { id:5, name:'Lychee',      icon:'🌸', bg:'#F4C0D1', fg:'#72243E' },
      { id:6, name:'Durian',      icon:'🌵', bg:'#C8A832', fg:'#1A1A1A' },
      { id:7, name:'Dragon Fruit',icon:'🐉', bg:'#D4537E', fg:'#fff' },
      { id:8, name:'Mango',       icon:'🥭', bg:'#E68755', fg:'#fff' },
      { id:9, name:'Pear',        icon:'🍐', bg:'#8BAC4A', fg:'#1A1A1A' },
      { id:10,name:'Avocado',     icon:'🥑', bg:'#4A6B1A', fg:'#fff' },
      { id:11,name:'Kiwi',        icon:'🥝', bg:'#6B8C2A', fg:'#fff' },
      { id:12,name:'Persimmon',   icon:'🍊', bg:'#E68755', fg:'#fff' },
      { id:13,name:'Peach',       icon:'🍑', bg:'#F4A58A', fg:'#7A2A1A' },
      { id:14,name:'Plum',        icon:'🫐', bg:'#7B5EA7', fg:'#fff' },
      { id:15,name:'Orange',      icon:'🍊', bg:'#E68755', fg:'#fff' },
      { id:16,name:'Nectarine',   icon:'🍑', bg:'#D4537E', fg:'#fff' },
      { id:17,name:'Sweet Potato',icon:'🍠', bg:'#C8A832', fg:'#1A1A1A' },
      { id:18,name:'Melon',       icon:'🍈', bg:'#8BAC4A', fg:'#1A1A1A' },
      { id:19,name:'Grape',       icon:'🍇', bg:'#7B5EA7', fg:'#fff' },
      { id:20,name:'Cherry',      icon:'🍒', bg:'#C84040', fg:'#fff' },
    ];
  }
